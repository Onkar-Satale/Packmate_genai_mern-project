...
//     // ✅ trips now come from backend (no hardcode)
...
//         fetchTrips(); // ✅ call inside useEffect
//     }, []);
...
//     const [currentTripIdx, setCurrentTripIdx] = useState(null);
//     const [newDetail, setNewDetail] = useState("");

//     // ✅ See Details modal state
//     const [seeModalOpen, setSeeModalOpen] = useState(false);
//     const [seeTripIdx, setSeeTripIdx] = useState(null);
...
//         if (!updatedTrips[currentTripIdx].additionalDetails) {
//             updatedTrips[currentTripIdx].additionalDetails = [];
//         }
//         updatedTrips[currentTripIdx].additionalDetails.push(newDetail);
...
//                             <div className="trip-card" key={trip._id || idx}>
//                                 <h3>{trip.location}</h3>

//                                 <p><strong>Duration:</strong> {trip.days} days</p>
//                                 <p><strong>People:</strong> {trip.people?.length || 0}</p>
...
//                                 <button onClick={() => openModal(idx)} className="add-details-btn">
//                                     Add Details
//                                 </button>

//                                 <button onClick={() => openSeeModal(idx)} className="see-details-btn">
//                                     See Details
//                                 </button>

//                                 <button onClick={() => deleteTrip(idx)} className="delete-trip-btn">
//                                     ❌ Delete Trip
//                                 </button>
//                             </div>
//                         ))
...
//             {/* See Details Modal */}
//             {seeModalOpen && seeTripIdx !== null && (
//                 <div className="modal-overlay">
//                     <div className="modal-content">
//                         <h2>{trips[seeTripIdx].location}</h2>

//                         <p><strong>Packing List:</strong></p>
//                         <ul>
//                             {trips[seeTripIdx].packingList?.map((item, i) => (
//                                 <li key={i}>{item}</li>
//                             ))}
//                         </ul>

//                         {trips[seeTripIdx].additionalDetails && (
//                             <>
//                                 <p><strong>Additional Notes:</strong></p>
//                                 <ul>
//                                     {trips[seeTripIdx].additionalDetails.map((d, i) => (
//                                         <li key={i}>{d}</li>
//                                     ))}
//                                 </ul>
//                             </>
...
//                         <button onClick={closeSeeModal}>Close</button>
//                     </div>
//                 </div>
//             )}

//             <footer className="account-footer">
//                 © 2026 PackMate. All rights reserved.
//             </footer>
//         </div>
//     );
// }
